package com.rapandroid.daftarbelanjaharian;
...
import com.rapandroid.daftarbelanjaharian.Data.Data;
...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference().child("Daftar Belanja Harian").child(uId);
